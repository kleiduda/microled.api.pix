...
namespace Microled.Pix.Application
{
    public class PixItauService : IPixItauService
    {
        ...
        public PixItauService(IPixBradescoHelper pixHelper, IConfiguration configuration)
        {
            _helper = pixHelper;
        ...
        public async Task<ServiceResult<PagamentoResponse>> CreateNewQrCodePix(PagamentoRequest request)
        {
            ...
            credentials.ClientSecret = _configuration.GetSection("CredenciaisItauo:client_secret").Value;
